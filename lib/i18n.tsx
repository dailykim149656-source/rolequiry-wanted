...
const COPY = {
  ko: {
    ...
    ambiguity: "긴장",
    unverified: "미확인",
    prioritiesReady: "이 항목부터 조사하면 됩니다",
    prioritiesReadyBody: "중요도는 이미 반영됐습니다. 다음 항목만 공개정보로 확인하세요.",
    starter1: "다음으로 확인할 항목을 고릅니다.",
    starter2: "공개정보에서 근거와 반대 신호를 찾습니다.",
    starter3: "면접에서 확인할 질문으로 남깁니다.",
    dossierLabel: "입사 전 확인 요약",
    blockersRemaining: "확인할 항목 {n}개 남음",
    blockersRemainingPlural: "확인할 항목 {n}개 남음",
    noBlockers: "당장 확인할 항목 없음",
    noQuestions: "열린 면접 질문이 없습니다.",
  ...
  en: {
    ...
    prioritiesReady: "Priorities ready",
    prioritiesReadyBody: "Your agent reads and writes this same case as the investigation moves forward.",
